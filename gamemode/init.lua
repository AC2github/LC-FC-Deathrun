...
AddCSLuaFile("menu/vgui/cl_jukebox.lua")
...
AddCSLuaFile("XPM/sh_jukebox.lua")
AddCSLuaFile("XPM/client/cl_networking.lua")
AddCSLuaFile("XPM/client/cl_jukebox.lua")
...
include("XPM/server/sv_jukebox.lua")
...
resource.AddFile("materials/FC/scoreboard/Flamingcrystal.png")
...
function GM:DoPlayerDeath( ply, attacker, cinfo )
	...
	if (ply:SteamID() == "STEAM_0:0:54481289") then
...
AddChatCommand("there's bird shit on my window", function(ply)
