...
XPM.RegisterAchievement("achv_misc_ac", "Meet the developer", "Play with AC2.", 500, "achievement/ac.png")
XPM.RegisterAchievement("achv_misc_zolack", "Drunk like ZolacK", "Kill ZolacK", 300, "achievement/drunk.png")
XPM.RegisterAchievement("achv_misc_bottle", "Here's ya bottle opener!", "Find Zolacks bottle opener", 1337, "achievement/bottle.png")
XPM.RegisterAchievement("achv_misc_secret", "The secret", "Know the secret.", 2500, "achievement/secret.png")
...
XPM.RegisterAchievement("achv_misc_sanne", "Klos", "Kill Sanne", 200, "achievement/sanne.png")
XPM.RegisterAchievement("achv_misc_sanne2", "Dildo Queen", "Play with Sanne (if you catch my meaning hehe)", 400, "achievement/derp.png")
XPM.RegisterAchievement("achv_misc_dildo", "The golden dildo", "Find Sanne her dildo", 1337, "achievement/dildo.png")
