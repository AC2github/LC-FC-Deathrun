...
function PANEL:Init()
	...
	self.XP:SetProgress(LocalPlayer().PlayerData["xp"], XPM.levels[100].xp)
	...
	self.Level:SetProgress(LocalPlayer().PlayerData["level"], 100)
	
	if not (LocalPlayer().PlayerData["level"] >= 100) then
